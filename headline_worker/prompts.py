...
Please classify the following article based on its title and content:
...
GLOBAL_INDUSTRY_PROMPT = '''Analyze the following news article in markdown format and its metadata:
   Markdown Content:
...
CITY_PROMPT = '''Analyze the following news article in markdown format and its metadata:
   Markdown Content:
   ${markdown.substring(0, 4000)}
   Metadata:
   ${metadataString}
